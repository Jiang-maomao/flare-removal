...
class Config_nore(object):
    ...
    def __init__(self, config_yaml: str, config_override: List[Any] = []):
        ...
        self._C.TRAINING.TRAIN_DIR = 'flare7k'
        self._C.TRAINING.VAL_DIR_1 = 'flare7k/real_test'
        self._C.TRAINING.VAL_DIR_2 = 'flare7k/syn_test'
        ...
        self._C.TESTING = CN()
        #self._C.TESTING.WEIGHT = '/LUT_2_8_epoch_152.pth'
        self._C.TESTING.SAVE_IMAGES = False

        self._C.datasets = CN()
        self._C.datasets.image_path = 'dataset/Flickr24K'
        self._C.datasets.scattering_dict = 'dataset/Flare7k/Scattering_Flare/Compound_Flare'
        #Flare7K_scattering: dataset/Flare7k/Scattering_Flare/Compound_Flare
        self._C.datasets.reflective_dict = 'dataset/Flare7k/Reflective_Flare'
        #Flare7K_reflective: dataset/Flare7k/Reflective_Flare
        self._C.datasets.img_size = 512
        # transform_base:
        # img_size: 512

        self._C.datasets.transform_flare = [0.8, 1.5, 300, 20]
        # scale_min: 0.8
        # scale_max: 1.5
        # translate: 300
        # shear: 20
